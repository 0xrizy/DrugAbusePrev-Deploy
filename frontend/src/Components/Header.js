      ...
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        {isOpen && (
          <div className="lg:hidden absolute top-16 right-4 bg-gray-700 p-4 rounded">
            ...
            {!token ? (
              ...
              <>
                <Link to="/userDashboard" className="block text-gray-300 py-2">
                  User Dashboard
                </Link>
                <button
                  onClick={handleClick}
        ...
        <div className="hidden lg:flex space-x-6 text-gray-500">
          ...
          {!token ? (
            ...
            <>
              <Link to="/userDashboard" className=" hover:text-gray-300 ">
                User Dashboard
              </Link>
              <div>
                <button
                  onClick={handleClick}
                  className=" border-2 rounded-xl px-4 bg-gray-700 hover:bg-gray-100 hover:text-gray-900 text-white "
                >
                  Logout
                </button>
              </div>
